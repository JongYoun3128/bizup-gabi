...
ORG:POINTGROUND
TITLE:총괄디렉터
TEL;TYPE=CELL:010-8407-8428
EMAIL:matching25.pointground@naver.com
...
END:VCARD`;
    ...
    link.href = url;
    link.download = "POINTGROUND_손가비_총괄디렉터.vcf";
...
function shareLine() {
    const url = window.location.href;
    const text = "POINTGROUND 손가비 총괄디렉터의 명함입니다";
...
// 이메일 공유
function shareEmail() {
    const subject = "POINTGROUND - 손가비 총괄디렉터 명함";
    const body = `POINTGROUND 손가비 총괄디렉터의 명함입니다.

회사: POINTGROUND
총괄디렉터: 손가비
전화: 010-8407-8428
이메일: matching25.pointground@naver.com
